...
const VERSION = 'cogitoergosum-v184';
...
const SHELL = [
  ...
  'data/teoria/cyber-dev3.md',
  'data/teoria/cyber-dev4.md',
  'data/teoria/cyber-dev5.md',
  'data/teoria/cyber-blue1.md',
  'data/teoria/cyber-blue2.md',
  'data/teoria/cyber-blue3.md',
  'data/teoria/cyber-blue4.md',
  'data/teoria/cyber-blue5.md',
  'data/teoria/cyber-mls1.md',
  'data/teoria/cyber-mls2.md',
  'data/teoria/cyber-mls3.md',
  'data/teoria/cyber-mls4.md',
  'data/teoria/cyber-mls5.md',
  ...
  // Fase 9 · IA Generativa — cluster Evaluación
  'data/teoria/gen-eval1.md',
  'data/teoria/gen-eval2.md',
  'data/teoria/gen-eval3.md',
  'data/teoria/gen-eval4.md',
  // Fase 9 · IA Generativa — cluster Agentes y RL
  'data/teoria/gen-ag1.md',
  'data/teoria/gen-ag2.md',
  'data/teoria/gen-ag3.md',
  'data/teoria/gen-ag4.md',
  // Fase 9 · IA Generativa — cluster Multi-agente
  'data/teoria/gen-ma1.md',
