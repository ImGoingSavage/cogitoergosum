...
1. **Copia texto íntegro de los libros si es necesario (LOS LIBROS FUERON COMPRADOS POR LOS USUARIOS Y EL DESARROLLADOR POR LO TANTO TIENEN PERMISOS)** (§3.11.5: copyright + pedagogía). si es necesario copia literalmente enunciados  y preguntas en el material. 
